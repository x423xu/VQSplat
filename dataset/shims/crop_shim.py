...
def center_crop(
    ...
    *_, h_in, w_in = images.shape
    ...
    intrinsics[..., 0, 0] *= w_in / w_out  # fx, rescale the fx to make the image look like being viewed from the same distance. if not scaled, the image will look zoomed in, the rgb loss increases due to pixel unmatchness.
